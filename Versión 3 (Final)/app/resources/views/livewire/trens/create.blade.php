    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Tren</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="Ejercicios_id" class="form-control" id="Ejercicios_id" placeholder="Ejercicios id">
                @error('Ejercicios_id') <span class="error text-danger">{{ $message }}</span> @enderror
